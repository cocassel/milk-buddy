                ...
                if(quantityLitre.length()==0){
                    ...
                    if(alcoholTest.equals("Fail") || sniffTest.equals("Fail") || densityTest.equals("Fail") ){
                        ...
                        if (quantityL > quantityLeftContainer) {
                            ...
                            builder.setMessage("Are you sure you want to proceed with current container? According to our records, quantity of milk being collected is greater than remaining capacity")
                                    .setCancelable(false)
                                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
